    ...
    <div class="container">
        <div class="row">
            ...
            <div class="card-body">
                ...
                {
                    ?>
                    <a href="editblog.php?blogid=<?php echo $info["blogid"];?>" class="btn btn-primary">Edit</a>
                    <a href="deleteblog.php?blogid=<?php echo $info["blogid"];?>" class="btn btn-danger">Delete</a>
                    <?php
                }
                ?>
            </div>
